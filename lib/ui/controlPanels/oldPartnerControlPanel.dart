...
class OldPartnerControlPanel extends StatefulWidget {
  final Business business;
  final User user;
  OldPartnerControlPanel({@required this.user, this.business});

  @override
  _OldPartnerControlPanelState createState() =>
      _OldPartnerControlPanelState(user, business);
}

class _OldPartnerControlPanelState extends State<OldPartnerControlPanel> {
  final User user;
  final Business business;
  final FireStoreUtils _fireStoreUtils = FireStoreUtils();

  _OldPartnerControlPanelState(this.user, this.business);
